...
class TSP(object):
    ...
    def create_data_model(self):
        ...
        self.input_data['distance_matrix'] = [
        ...
        self.input_data['num_vehicles'] = 1
        self.input_data['depot'] = 0
        print('FINE')
    ...
    def solve(cls, path):
        ...
        manager = pywrapcp.RoutingIndexManager(
            len(classe.input_data['distance_matrix']),
            classe.input_data['num_vehicles'],
            classe.input_data['depot'],
        )
        ...
        def distance_callback(from_index, to_index):
            ...
            return classe.input_data['distance_matrix'][from_node][to_node]
        ...
        # Print solution on console.
        if solution:
            cls.print_solution(cls, manager, routing, solution)
